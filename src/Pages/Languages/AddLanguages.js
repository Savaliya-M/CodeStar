                ...
                <div className='add-lang-section px-48 pt-10'>
                    <div className='input'>
                        <div className='flex w-full'>
                            <input className='w-4/5 mr-1 text-2xl py-2 px-3 border-2' placeholder='New Language' type="text" name="language" />
                            <button className='btn-add text-2xl w-1/5 flex justify-center items-center text-center '>ADD<AiOutlinePlusCircle className='ml-2' /> </button>
                        </div>
                        <div className='select-file-container mt-6 py-10 flex flex-col items-center leading-10 cursor-pointer text-xl'>
