...
const Collapsible = ({ children }) => {
  ...
  return (
    <>
      <div
        className="link flex align-middle items-center   text-xl"
        onClick={() => setListtoggale(!listtoggale)}
      >
        ...
        <div className="link-text flex">
          ...
          {listtoggale ? (
            ...
            <MdOutlineKeyboardArrowDown className="ml-20 font-extrabold text-3xl" />
          )}
        </div>
      </div>
      <div
